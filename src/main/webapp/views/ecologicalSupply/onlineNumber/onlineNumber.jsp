...
<script type="text/javascript">
	...
	function fncExcel(){
		actSubmit($('#form'), ctx+"/onlineNumber/queryOnlineNumberExcel");
	}
	
	function fncSave(){
		$.ajax({
			url:ctx+"/onlineNumber/saveOnlinePara",
			type:"POST",
			data:
			{
				onlinePara:$("#onlinePara").val()
			},
			success:function(data){
				if(data == "ok" ){
					rayDialog("计算完成！",function(){
						actCancel($('#form'), ctx + "/onlineNumber");												
					});
				}
			} 
		}); 
				...
				<div class="col-xs-12 col-sm-12">
				  <div class="box">
					...
					<div class="box-content">
							<form class="form-horizontal" id="form" action="/onlineNumber/onlineNumberList" method="post">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">生态保护情景参数1</label>
									<div class="col-sm-2">
										<input type="text" value="${data.onlinePara}" id="onlinePara" name="onlinePara" class="form-control" 	placeholder="情景参数" data-query="yes" data-toggle="tooltip" data-placement="bottom" >
									</div>
								</div>
								<div class="form-group">
							...
							<thead>
								<tr>
									<tr>
										...
										<th data-column="onlineNumber">生态供给上限量</th>
