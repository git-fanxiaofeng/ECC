package io.raycom.modules.agr.agrWasterate;
 ...
 */
@Controller
@RequestMapping(value="${adminPath}/agrWasterate")
public class AgrWasterateController extends BaseController{
	
	@Autowired
	private AgrWasterateService agrProductionService;
	...
	public String list(){
		return "agr/agrWasterate/agrWasterateList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="agrWasterateList")
	@ResponseBody
	...
	public RData generateOrders() {
        ...
        try { 
            ...
            for(int j=1;j<rowNum;j++){
            	...
            	AgrWasterateBean sBean = new AgrWasterateBean();
