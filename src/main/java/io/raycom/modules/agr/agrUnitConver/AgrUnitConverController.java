package io.raycom.modules.agr.agrUnitConver;
 ...
 */
@Controller
@RequestMapping(value="${adminPath}/agrUnitConver")
public class AgrUnitConverController extends BaseController{
	
	@Autowired
	private AgrUnitConverService agrProductionService;
	...
	public String list(){
		return "agr/agrUnitConver/agrUnitConverList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="agrUnitConverList")
	@ResponseBody
	...
	public RData generateOrders() {
        ...
        try { 
            ...
            for(int j=1;j<rowNum;j++){
            	...
            	AgrUnitConverBean sBean = new AgrUnitConverBean();
