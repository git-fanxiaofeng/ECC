package io.raycom.modules.agr.agrHarvestIndex;
 ...
 */
@Controller
@RequestMapping(value="${adminPath}/agrHarvestIndex")
public class AgrHarvestIndexController extends BaseController{
	
	@Autowired
	private AgrHarvestIndexService agrProductionService;
	...
	public String list(){
		return "agr/agrHarvestIndex/agrHarvestIndexList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="agrHarvestIndexList")
	@ResponseBody
	...
	public RData generateOrders() {
        ...
        try { 
            ...
            for(int j=1;j<rowNum;j++){
            	...
            	AgrHarvestIndexBean sBean = new AgrHarvestIndexBean();
