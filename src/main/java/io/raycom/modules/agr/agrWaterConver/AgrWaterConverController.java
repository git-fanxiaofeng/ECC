 ...
 */
@Controller
@RequestMapping(value="${adminPath}/agrWaterConver")
public class AgrWaterConverController extends BaseController{
	
	@Autowired
	private AgrWaterConverService agrProductionService;
	...
	public String list(){
		return "agr/agrWaterConver/agrWaterConverList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="agrWaterConverList")
	@ResponseBody
	...
	public RData generateOrders() {
        ...
        try { 
            ...
            for(int j=1;j<rowNum;j++){
            	...
            	AgrWaterConverBean sBean = new AgrWaterConverBean();
