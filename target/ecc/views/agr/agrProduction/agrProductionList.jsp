...
<script type="text/javascript">
	...
	function fncAdd() {
		actSubmit($('#form'), ctx + "/vendorDrugDict/add");
	}
	...
	function importExcel() {
		if($("#materialfiled1").val()==""||$("#materialfiled1").val()==null){
			...
			rayDialogConfirm("确定要上传吗？",function(){
				$.ajax({
					url:ctx+"/agr/agrProduction/import",
					type:"POST",
					data:
					{
					...
					success:function(data){
						if(data.hasError == "Y" ){
							...
							rayDialog("导入成功！",function(){
								actCancel($('#form'), ctx + "/vendorDrugDict");												
							});
						}
					} 
				}); 
				...
				<div class="col-xs-12 col-sm-12">
				  <div class="box">
					...
					<div class="box-content">
							<form class="form-horizontal" id="form" action="/agr/agrProduction" method="post">
